...
//    }
    ...
    public Employee_p[] getEmployee() {
        Employee_p[] employee_ps = employeeMapper_p.getEmployees();
        return employee_ps;
    }
...
//
    ...
    //通过empId查询employee
    @Override
    public Employee_p getEmployeeById(String empId) {
        Employee_p employee_p = employeeMapper_p.selectByEmpId(empId);
        return employee_p;
    }
}
